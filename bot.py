...
def callback_inline(call):
    if call.data == "menu_evaluation":
        ...
        bot.send_message(
            call.message.chat.id,
            "ℹ️ **Умови викупу**\n\n"
            "Ми купуємо автомобілі будь-якого стану, швидко та без зайвих турбот:\n"
            "✅ Биті та проблемні\n"
            "✅ Після ДТП\n"
            "✅ Після пожежі\n"
            "✅ Без документів\n"
            "✅ Нерастаможені\n\n"
            "⚡ Гроші виплачуємо одразу, оформлення за наш рахунок.\n\n"
            "💡 Продаючи авто нам, ви отримуєте чесну оцінку, швидку угоду та гарантію безпечного продажу. "
            "Ми дбаємо про кожного клієнта та робимо процес максимально прозорим і комфортним!",
            reply_markup=back_keyboard()
        )
